...
function LS.InitTabs(...)
	...
	LS.AddDropdown(#arg-1, 1, 0, "TopTrinketCondition", "Top Trinket Usage", "Rotation Helper", "At HP", "Rotation Helper", "On Cooldown", "Don't Use");
	...
	LS.AddDropdown(#arg-1, 2, 0, "BottomTrinketCondition", "Bottom Trinket Usage", "Rotation Helper", "At HP", "Rotation Helper", "On Cooldown", "Don't Use");
